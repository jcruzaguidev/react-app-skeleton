...
export const ProductCard = (props:Props) => {
   ...
   return (
      <>
         <StylesProductCard img={ process.env.PUBLIC_URL + "menu/" + menuKey + ".jpg" }>
         ...
         <ProductCardModal showModal={ showModal } setShowModal={ setShowModal } product={ product } counter={ counter }
                           setCounter={ setCounter } increaseBy={ increaseBy } />
      </>
   );
};
